# -*- coding: utf-8 -*-
"""Firda Humaira_MLT Project 1.ipynb

Automatically generated by Colab.

Original file is located at
    https://colab.research.google.com/drive/1WjjzRMkPkYsBIIb12emS9jqKMh6jAVUr
...
"""Penjelasan sama dengan yang dije;aslan di deskripsi statistik"""
...
- Supaya fitur dengan skala besar (misalnya: Insulin atau Glucose) tidak mendominasi fitur lain seperti BMI atau Age dalam proses training model.
...
"""**insight:**
- Tidak ada lagi fitur yang dominasinya terlalu besar (misalnya "Insulin" atau "Age" yang sebelumnya punya nilai jauh lebih tinggi dari fitur lain).
